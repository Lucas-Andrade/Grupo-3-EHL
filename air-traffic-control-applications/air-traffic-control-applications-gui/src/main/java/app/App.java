 ...
 * </ul>
 * 
 * It will open the main window. At the top right corner, you see all the {@code User}
 * functionalities. At the bottom you see all the {@code Airships} functionalities.
 * 
 * User Buttons:
 * <ul>
 * <li>POST a new user
 * <li>GET all users: it will open a new window, with a list of all posted user. Click in one to see
 * it info.
 ...
 * <li>GET all airships: not working, we don't know why :(, to see all posted airships logout and
 * login again. It will appear the posted airships in the world image, and a list at the right. To
 * see an Airship info click on one.
