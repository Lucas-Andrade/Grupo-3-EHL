...
public class CheckIfAirshipIsTransgressingCommand_Tests
{
        ...
        throws Exception
    {
        ...
        checkIfAirshipIsTransgressing =
                new CheckIfAirshipIsTransgressingCommand( airshipsDatabase, airship1.getIdentification() );

        String testedInformation1 = checkIfAirshipIsTransgressing.call();

        checkIfAirshipIsTransgressing =
                new CheckIfAirshipIsTransgressingCommand( airshipsDatabase, airship2.getIdentification() );
        ...
        throws InvalidArgumentException
    {
        ...
        checkIfAirshipIsTransgressing = new CheckIfAirshipIsTransgressingCommand( airshipsDatabase, null );
    }
}
