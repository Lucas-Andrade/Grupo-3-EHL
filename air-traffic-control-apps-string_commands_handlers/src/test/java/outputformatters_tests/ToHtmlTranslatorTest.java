 ...
 * visual tests meant to be seen on console.
 * 
...
//            
//            
//            ToHtmlTranslator t = new ToHtmlTranslator( 3 );
//            String visualDelimiter = "\n\n\n-----------------------------------------------\n\n\n";
//            
//            
//            // NULL
//            Optional< ? > nulo = new Optional<>( null, new Exception( "nulo" ), "empty" );
//            System.out.println( t.encode( ToTranslatableConverter.convert( nulo ) ) );
//            
//            
//            
...
//            System.out.println( t.encode( ToTranslatableConverter.convert( empty ) ) );
//            
//            
//            // OBJECTS INSTANTIATION
//            User user1 = new User( "Pedro", "pass", "pedro@gmail.com", "Pedro Antunes" );
...
//            System.out.println( t.encode( ToTranslatableConverter.convert( user ) ) );
//            
//            
//            
//            System.out.println( visualDelimiter );
//            
//            // AIRSHIP Civ
//            Optional< Airship > a1 = new Optional<>( airship1, new Exception( "exc2" ) );
...
//            
//            // AIRSHIP Mil
//            Optional< Airship > a2 = new Optional<>( airship2, new Exception( "exc2" ) );
...
//            
//            // CIVIL
//            Optional< CivilAirship > civil = new Optional<>( airship4, new Exception( "exc4" ) );
//            System.out.println( t.encode( ToTranslatableConverter.convert( civil ) ) );
//            
//            
//            
//            System.out.println( visualDelimiter );
//            
//            // MILITARY
//            Optional< MilitaryAirship > milit = new Optional<>( airship5, new Exception( "exc5" ) );
//            System.out.println( t.encode( ToTranslatableConverter.convert( milit ) ) );
//            
//            
//            
//            System.out.println( visualDelimiter );
...
//            us.add( user1 );
//            us.add( user2 );
//            Optional< Iterable< User >> users =
//                    new Optional<>( us, new Exception( "null" ), "empty1" );
//            System.out.println( t.encode( ToTranslatableConverter.convert( users ) ) );
//            
//            
//            
//            System.out.println( visualDelimiter );
...
//            cs.add( airship1 );
//            cs.add( airship4 );
//            Optional< Iterable< Airship >> civils =
//                    new Optional<>( cs, new Exception( "null" ), "empty2" );
//            System.out.println( t.encode( ToTranslatableConverter.convert( civils ) ) );
//            
//            
//            
//            System.out.println( visualDelimiter );
...
//            ms.add( airship6 );
//            ms.add( airship5 );
//            Optional< Iterable< MilitaryAirship >> milits =
//                    new Optional<>( ms, new Exception( "null" ), "empty3" );
//            System.out.println( t.encode( ToTranslatableConverter.convert( milits ) ) );
//            
//            
//            
//            System.out.println( visualDelimiter );
...
//            as.add( airship1 );
//            as.add( airship3 );
//            Optional< Iterable< Airship >> airships =
//                    new Optional<>( as, new Exception( "null" ), "empty4" );
//            System.out.println( t.encode( ToTranslatableConverter.convert( airships ) ) );
//            
//            
//            
//            System.out.println( visualDelimiter );
...
//            System.out.println( t.encode( ToTranslatableConverter.convert( list ) ) );
//            
//            
//            
//        }
//        catch( InvalidArgumentException | UnknownTranslatableException | UnknownTypeException e ) {
