    ...
    extends Exception
{
    ...
    /**
     * Constructs a {@link MissingRequiredParameterException} with the message
     * <i>«Required parameter with name {@code parameterName} missing.»</i>.
     * 
     * @param parameterName
    ...
    /**
     * Constructs an {@link MissingRequiredParameterException} with the message
     * <i>«Required parameter with name {@code parameterName} missing.»</i> and
     * the specified cause.
     * 
     * @param parameterName
     *        The missing parameter's name.
