 ...
 * of Optional may have unpredictable results and should be avoided.
 * </p>
 *
...
public class Optional< T >
{
     ...
     *        {@code value==null}. If this argument is {@code null}, the method
     *        {@link #get()} will throw a {@link NullValueInOptionalException}
     *        with message <i>«null»</i> if {@code value==null}.
     */
    public Optional( T value, Exception toBeThrownIfNull )
    {
        ...
        this.toBeThrownIfNull =
                ( toBeThrownIfNull == null ) ? new NullValueInOptionalException( "null" ) : toBeThrownIfNull;
     ...
     *        {@code value.is Empty()}. If this argument is {@code null}, the
     *        method {@link #toString()} will return {@code value.toString()} if
     *        {@code value.isEmpty()}.
     */
     ...
     *
     * @return {@code true} if the stored value is {@code null}; </br>
    ...
    public T get() throws Exception
    {
        ...
        if( value == null ){ throw toBeThrownIfNull; }
        return value;
    }
    ...
    /**
     * Indicates whether {@code obj} is "equal to" {@code this}. The object
     * {@code obj} is considered equal to {@code this} if it is also an instance
     * of {@code Optional} and
     * <ul>
     * <li>both instances store {@code null} or
     * <li>the values stored in both instances are equal via method
     * {@code equals()} of class {@code T}.
     * </ul>
     *
     * @param obj
     *        The object to be compared with {@code this}.
     * @return {@code true} if {@code obj} is "equal to" {@code this}; </br>
     *         {@code false} otherwise.
     */
    @Override
    ...
    /**
     * Returns the hash code value of the stored value. If this value is
     * {@code null}, its hash code is {@code 0}.
     *
    ...
    /**
     * Returns a string representation of the value represented by this instance
     * of {@link Optional} .
     * <p>
     ...
     * </p>
     *
     * @return A string representation of the value represented by this instance
     *         of {@link Optional} .
     */
    @Override
