...
import design.windows.WindowBase;
     ...
     *   This instance also add two {@link JLablePlusJTextField} and has this configuration: 
     *   
     *  <pre>
...
public class LogInWindow extends WindowBase {
    ...
    */
    ...
    /**
     * {@code BOTTOMINSECTSFORUSERPANEL} int value that represents the size of bottom borders for {@code userPanel} used in
     * {@code GridBagConstraints}.
     */
    private static final int BOTTOMINSECTSFORUSERPANEL = 0;
    /**
     * {@code BOTTOMINSECTSFORPASSWORDPANEL} int value that represents the size of bottom borders for {@code passwordPanel} used in
     * {@code GridBagConstraints}.
     */
