 ...
 * instance also add four {@link JLablePlusJTextField} and has this configuration:
 * 
 * <pre>
...
public class PatchUserWindow extends WindowBase {
    ...
    /**
     * {@code YPOSITIONFORNEWPASSWORD} int value that represents the rows where is insert the
     * {@code newPasswordPanel} components into {@code GridBagConstraints}.
     */
    ...
    /**
     * {@code userPanel} variable that represents {@link JLablePlusJTextField} that is part of this
     * {@link JDialog}.
     */
    ...
    /**
     * {@code newPasswordPanel} variable that represents {@link JLablePlusJTextField} that is part
     * of this {@link JDialog}.
     */
    ...
    /**
     * Public constructor that creates a new {@link PatchUserWindow} adding four
    ...
    public PatchUserWindow() {
        ...
        this.getContentPane()
            .add( oldPasswordPanel,
                  GridBagUtils.updateGridBagConstraints( constraints, XPOSITIONFORPANELS,
                                                         YPOSITIONFOROLDPASSWORD,
                                                         new Insets( TOPINSECTS, LEFTINSECTS,
                                                                     BOTTOMINSECTS, RIGHTINSECTS ) ) );
        
        newPasswordPanel =
                new JLablePlusJTextField( "New Password", JTEXTFIELDSIZE, Color.WHITE, true );
        this.getContentPane()
            .add( newPasswordPanel,
                  GridBagUtils.updateGridBagConstraints( constraints, XPOSITIONFORPANELS,
                                                         YPOSITIONFORNEWPASSWORD,
                                                         new Insets( TOPINSECTS, LEFTINSECTS,
                                                                     BOTTOMINSECTS, RIGHTINSECTS ) ) );
        ...
        this.getContentPane()
            .add( newPasswordConfirmationPanel,
                  GridBagUtils.updateGridBagConstraints( constraints, XPOSITIONFORPANELS,
                                                         YPOSITIONFORCONFIRMNEWPASSWORD,
                                                         new Insets( TOPINSECTS, LEFTINSECTS,
                                                                     BOTTOMINSECTS, RIGHTINSECTS ) ) );
