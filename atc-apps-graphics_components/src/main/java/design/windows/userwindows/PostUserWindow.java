 ...
 * instance also add five {@link JLablePlusJTextField} and has this configuration:
 * 
 * <pre>
...
public class PostUserWindow extends WindowBase {
    ...
    /**
     * {@code RIGHTINSETS} int value that represents the size of right borders for {@code userPanel}
     * used in {@code GridBagConstraints}.
     */
    ...
    /**
     * {@code YPOSITIONFORUSERNAME} int value that represents the rows where is insert the
     * {@code username} components into {@code GridBagConstraints}.
     */
    private static final int YPOSITIONFORUSERNAME = 1;
    /**
     * {@code YPOSITIONFORPASSWORD} int value that represents the rows where is insert the
     * {@code password} components into {@code GridBagConstraints}.
     */
    private static final int YPOSITIONFORPASSWORD = 2;
    /**
     * {@code YPOSITIONFORCONFIRMPASSWORD} int value that represents the rows where is insert the
     * {@code confirmPassword} components into {@code GridBagConstraints}.
     */
    private static final int YPOSITIONFORCONFIRMPASSWORD = 3;
    /**
     * {@code YPOSITIONFOREMAIL} int value that represents the rows where is insert the
     * {@code email} components into {@code GridBagConstraints}.
     */
    private static final int YPOSITIONFOREMAIL = 4;
    /**
     * {@code YPOSITIONFORFULLNAME} int value that represents the rows where is insert the
     * {@code fullname} components into {@code GridBagConstraints}.
     */
    ...
    /**
     * Public constructor that creates a new {@link PostUserWindow} adding five
        ...
        this.getContentPane()
            .add( username,
                  GridBagUtils.updateGridBagConstraints( constraints, XPOSITIONFORPANELS,
                                                         YPOSITIONFORUSERNAME,
                                                         new Insets( TOPINSECTS, LEFTINSECTS,
                                                                     BOTTOMINSECTS, RIGHTINSECTS ) ) );
        
        password = new JLablePlusJTextField( "Password", JTEXTFIELDSIZE, Color.WHITE, true );
        this.getContentPane()
            .add( password,
                  GridBagUtils.updateGridBagConstraints( constraints, XPOSITIONFORPANELS,
                                                         YPOSITIONFORPASSWORD,
                                                         new Insets( TOPINSECTS, LEFTINSECTS,
                                                                     BOTTOMINSECTS, RIGHTINSECTS ) ) );
        
        confirmPassword =
                new JLablePlusJTextField( "Confirm Password", JTEXTFIELDSIZE, Color.WHITE, true );
        this.getContentPane()
            .add( confirmPassword,
                  GridBagUtils.updateGridBagConstraints( constraints, XPOSITIONFORPANELS,
                                                         YPOSITIONFORCONFIRMPASSWORD,
                                                         new Insets( TOPINSECTS, LEFTINSECTS,
                                                                     BOTTOMINSECTS, RIGHTINSECTS ) ) );
