 ...
 */
public class FunctionalGetAirshipsWithLessPassengerThanWindow
        extends
     ...
     * {@link GetAirshipsWithLessPassengerThanWindow}s.
     */
    private static SwingWorkerFactory< FunctionalGetAirshipsWithLessPassengerThanWindow.SwingWorker, Iterable< SimpleAirship > > swFactory;
    /**
    ...
    public static
            boolean
            setSwingWorkerFactory( SwingWorkerFactory< FunctionalGetAirshipsWithLessPassengerThanWindow.SwingWorker, Iterable< SimpleAirship > > factory ) {
    
        return Utils.setSWFactory( FunctionalGetAirshipsWithLessPassengerThanWindow.class,
