 ...
 * airships who transgressed their air corridor.
 *
...
public class GetReportOfTransgressionByIdCommand extends GetAirshipsCommand
{
	...
	public static class Factory implements CommandFactory
	{
		...
		public Command newInstance( Map< String, String > parameters ) {
			...
			return new GetReportOfTransgressionByIdCommand(
					airshipsDatabaseWhereToSearch, parameters );
		}
	 ...
	 */	
	public GetReportOfTransgressionByIdCommand(
			InMemoryAirshipDatabase airshipsDatabaseWhereToSearch,
	...
	protected void internalExecute() {
		...
		Collection< Airship > aircraft = airshipsDatabase
				.reportTransgressions();
		
		
		StringBuilder flightIDs = new StringBuilder();
		
		if( aircraft.isEmpty() )
			flightIDs.append( "There are no transgressions records" );
		else
		{
			for( Airship element : aircraft )
			{
				
				flightIDs.append( "\n Airship flightID: " ).append(
	 ...
	 * Override of {@link AbstractCommand}
	 * 
	 * Method responsible to get the required parameters to create this
	 * Command
	 * 
	 */	
	@Override
