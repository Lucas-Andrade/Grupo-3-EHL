...
public abstract class PostCommand< T extends Element > extends AbstractCommand
{
	 ...
	 */
	public PostCommand( InMemoryUserDatabase usersDatabase,
			Database< T > database, Map< String, String > parameters ) {
	 ...
	 *             {@link #usersDatabase users database}. TODO
	 * @throws WrongLoginPasswordException
	 *             If the user who is trying to post gave a wrong password.
	 */
	 ...
	 */
	protected abstract void internalPostExecute()
