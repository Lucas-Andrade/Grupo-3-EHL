 ...
 * {@link #registerCommand(String, String, FactoryOfStringParametrizedCallables)
 ...
 * format <code>{{@literal<}string>}</code> are placeholders.
 * </p>
 * <p>
...
public class CommandParser
{
	...
	private static class Node
	{
		...
		/**
		 * Creates a placeholder node with {@link #content}
		 * {@code currentContent} or returns 
		 * 
	...
	public Command getCommand( String... args )
			throws UnknownCommandException, DuplicateParametersException,
	 ...
	 *            recursion).
	 * @param cmdFactory
	 *            The {@link FactoryOfStringParametrizedCallables} instance to
	 ...
	 *             if the command is not recognized
	 */
	private Command getCommandInternal( Node rootNode,
