...
/**
 * Abstract class whose instances represent in-memory databases of elements that have an
...
public abstract class InMemoryDatabase<T extends Element> implements Database<T> {
	...
	/**
	 * The container of elements. In this {@link Map}, the keys are the elements' identifications
	 * (obtained via method {@link Element#getIdentification()} and the values are the elements.
	 */
