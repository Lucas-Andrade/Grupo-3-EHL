...
public class ConsultFlightDetailsOption extends Option
{
	...
	public ConsultFlightDetailsOption() {
		super( "Consult a flight's details." );
	};
	 ...
	 * <p>
	 * Uses the
	 * {@link airtrafficcontrol.deprecated.AirTrafficControlAppToolbox#flightsDB
	...
	public String execute() throws FlightNotFoundInDatabaseException,
		...
		AirCraft airship = flightsDB.getAirplane( flightID );
		// new ReportGenerator().
