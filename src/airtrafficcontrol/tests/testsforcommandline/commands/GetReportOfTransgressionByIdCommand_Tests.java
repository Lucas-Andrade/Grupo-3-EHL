...
/**
 * 
 * Those Tests were created to test the {@link GetReportOfTransgressionByIdCommand} Class 
...
public class GetReportOfTransgressionByIdCommand_Tests {  
	...
	public void BeforeTests() throws InvalidRegisterException {	
		...
		commandParser.registerCommand("GET", "/airships/reports/{flightId}", new GetReportOfTransgressionByIdCommand.Factory(airshipsDatabaseWhereToSearch));	
	...
	public void VerifyThatAirshipTransgressedTheAltitudeParameter() throws Exception  {
		...
		GetReportOfTransgressionByIdCommand getReport = (GetReportOfTransgressionByIdCommand) commandParser.getCommand("GET","/airships/reports/1");	
		getReport.execute();
	...
	GetReportOfTransgressionByIdCommand getReport = (GetReportOfTransgressionByIdCommand) commandParser.getCommand("GET","/airships/reports/2");	
	getReport.execute();
