...
/**
 * This class represents the option "Configurations."
 * from the {@code Option Menu} of this app. The {@code title} of this option is
 * "Configurations." and {@code description} is a string
 ...
 */
public class ConfigurationsOption implements Option
{
	 ...
	 */
	private static String title = "Configurations.";
	 ...
	 */
	public static final ConfigurationsOption instance = new ConfigurationsOption();
