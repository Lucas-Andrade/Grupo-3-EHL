...
/**
 * This class represents the option "Monitor Air Traffic."
 * from the {@code Option Menu} of this app. The {@code title} of this option is
 * "Monitor Air Traffic." and {@code description} is a string
 ...
 */
public class MonitorAirTrafficOption implements Option
{
	 ...
	 */
	private static String title="Monitor Air Traffic.";
	 ...
	 */
	public static final MonitorAirTrafficOption instance = new MonitorAirTrafficOption();
	 ...
	 * Private constructor.
	 */
	private MonitorAirTrafficOption() {};
