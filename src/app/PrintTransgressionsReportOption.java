...
/**
 * This class represents the option "Print a report of transgressions to a text file."
 * from the {@code Option Menu} of this app. The {@code title} of this option is
 * "Print a report of transgressions to a text file." and {@code description} is a string
 ...
 */
public class PrintTransgressionsReportOption implements Option
{
	 ...
	 */
	private static String title="Print a report of transgressions to a text file.";
	 ...
	 */
	public static final PrintTransgressionsReportOption instance = new PrintTransgressionsReportOption();
	 ...
	 * Private constructor.
	 */
	private PrintTransgressionsReportOption() {};
