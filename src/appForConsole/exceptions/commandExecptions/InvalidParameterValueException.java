...
import appForConsole.exceptions.commandParserExceptions.CommandParserException;

@SuppressWarnings ("serial")
public class InvalidParameterValueException extends CommandException {

	/**
	 * Constructs a {@link CommandParserException} with the message <i>«Required parameter with name
