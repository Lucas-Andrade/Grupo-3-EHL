...
public class DuplicateParametersException extends CommandParserException {
	...
	/**
	 * Constructs a {@link DuplicateParametersException} with the message <i>«Required parameter
	 * with name {@code parameterName} has multiple values.»</i>.
	 * 
	 * @param parameterName
	...
	public DuplicateParametersException(String parameterName) {
		...
		super(MessageFormat.format("Parameter with name {0} has multiple values.", parameterName));
	}
}