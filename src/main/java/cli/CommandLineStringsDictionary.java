...
/**
 * A list of correspondences between {@link String}s contained in
 * string-commands and their internal meaning in the app.
 * <p>
 * This app takes strings as input; these strings hold information on which
 * operation to perform and contain data needed to perform them. Therefore they
 ...
 * time a new command is created or a new functionality is added to the already
 * existent commands, the new names and values of its placeholders and/or
 * parameters names are to be added in this list.
 * </p>
 *
