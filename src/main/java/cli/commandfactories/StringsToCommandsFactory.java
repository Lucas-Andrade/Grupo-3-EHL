 ...
 *            the method {@link #newInstance(Map)}.
 * @see Callable
 * @see Map
 */
public abstract class StringsToCommandsFactory< R > implements
		CallablesFactory< R, String, String >
{
	 ...
	 */
	public StringsToCommandsFactory( String commandDescription )
			throws InvalidArgumentException {
		
		if( commandDescription == null )
			throw new InvalidArgumentException(
					"Cannot instantiate factory without description!" );
	 ...
	 */
	private void checkIfAllRequiredParametersAreInTheParametersMap(
	 ...
	 *             parameter invalid (e.g. is not convertible to the expected
	 *             type).
