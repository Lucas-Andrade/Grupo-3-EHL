...
import main.java.cli.commandfactories.postfactories.PostCommandsFactory;
...
public class PatchAirshipsCommandFactory extends PostCommandsFactory<Airship, String> {
	...
	@Override
	protected Callable<String> postsInternalNewInstance(User userWhoIsPosting) throws Exception {
