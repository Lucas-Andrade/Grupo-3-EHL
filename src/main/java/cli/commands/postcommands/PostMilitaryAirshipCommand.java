...
/**
 * Class whose instances represent commands to post a military airship.
 * Implements {@code Callable<String>}.
 *
...
public class PostMilitaryAirshipCommand implements Callable< String >
{
	...
	// CONSTRUCTOR
	/**
	 * Creates a new instance of this command that adds a military airship with
	 ...
	 */
	public PostMilitaryAirshipCommand( double latitude, double longitude,
			double altitude, double maxAltitude, double minAltitude,
			boolean hasArmours, Database< Airship > airshipsDatabase,
	...
	/**
	 * Adds a new military airship with the properties given in the constructor
	 * to the database given in the constructor.
	 * 
	...
	public String call() throws Exception {
		...
		Airship theMilitaryAirship = new MilitaryAirship( latitude, longitude,
				altitude, maxAltitude, minAltitude, hasArmours );
		String flightId = theMilitaryAirship.getIdentification();
		
		if( databaseWhereToPost.add( theMilitaryAirship, userWhoIsPosting ) )
