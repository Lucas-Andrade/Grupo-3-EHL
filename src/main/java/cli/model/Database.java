...
public interface Database<T extends Element> {
	...
	/**
	 * Returns the element of this database whose identification is {@code identification} or
	 * returns {@code null} if there's no such element in this database. This result is wrapped in
	 * an {@link Optional} instance.
	 * 
	 * @param identification
