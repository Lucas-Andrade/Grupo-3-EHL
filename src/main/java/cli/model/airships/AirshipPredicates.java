...
public class AirshipPredicates
{
	...
	/**
	 * Tests if an instance of {@link Airship} is instance of
	 * {@link CivilAirship} and its number of passengers is below
			...
			Predicate< Airship >
	{
		...
		public HasPassagersNumberBelowAThreshold(
	...
	/**
	 * Class that tests if an instance of {@link Airship} is transgressing its
	 * pre-established air corridor.
	 * 
	 * @author Daniel Gomes, Eva Gomes, Gonçalo Carvalho, Pedro Antunes
	 */
	public static class IsTrangressingItsAirCorridor implements
			Predicate< Airship >
	{
		/**
