...
public class InMemoryUsersDatabase extends InMemoryDatabase<User> {
	...
	// CONSTRUTOR
	/**
	 * Creates a new instance of {@link InMemoryUserDatabase} with name {@code databaseName} and
	 ...
	 * @return {@code true} if the user was successfully added;</br> {@code false} if there's
	 *         already a user with the same username or email.
	 * @throws InvalidArgumentException
	 ...
	 * @return {@code true} if the user was successfully removed; </br> {@code false} otherwise.
