...
class IterablesToTranslatables
{
	 ...
	 */
	static class IterableUserConversor extends Conversor
	{
		...
		Translatable convert( Object iterableOfUsers )
			...
			catch( ClassCastException e )
			{
				throw new UnknownTypeException( "Could not convert "
						+ iterableOfUsers + " into a translatable." );
			}
			...
			return new Translatable( "users", "user", null, null,
					propertiesBag, null );
		}
	}
	 ...
	 * @author Daniel Gomes, Eva Gomes, Gonçalo Carvalho, Pedro Antunes
	 */
	static class IterableAirshipConversor extends Conversor
	{
		@SuppressWarnings( "unchecked" )
		@Override
