...
class SimpleInstancesToTranslatables
{
	 ...
	 */
	static class UserConversor extends Conversor
	{
	 ...
	 * @author Daniel Gomes, Eva Gomes, Gonçalo Carvalho, Pedro Antunes
	 */
	static abstract class AirshipConversor extends Conversor
	{
		...
		Map< String, Object > createAirshipPropertiesBag( Airship airship ) {
			...
			Map< String, Object > propertiesBag = new LinkedHashMap< String, Object >();
			propertiesBag.put( CLIStringsDictionary.FLIGHTID,
					airship.getIdentification() );
			propertiesBag.put( CLIStringsDictionary.LATITUDE, airship
					.getCoordinates().getLatitude().getValue() );
			propertiesBag.put( CLIStringsDictionary.LONGITUDE, airship
					.getCoordinates().getLongitude().getValue() );
			propertiesBag.put( CLIStringsDictionary.ALTITUDE, airship
					.getCoordinates().getAltitude().getValue() );
	 ...
	 * @author Daniel Gomes, Eva Gomes, Gonçalo Carvalho, Pedro Antunes
	 */
	static class CivilAirshipConversor extends AirshipConversor
	{
		...
		Translatable convert( Object civilAirship ) throws UnknownTypeException {
			...
			propertiesBag.put( CLIStringsDictionary.NUMBEROFPASSENGERS,
					ca.getPassengers() );
	 ...
	 * @author Daniel Gomes, Eva Gomes, Gonçalo Carvalho, Pedro Antunes
	 */
	static class MilitaryAirshipConversor extends AirshipConversor
	{
