 ...
 * </pre>
 * 
 * String-commands are string representations of {@link Callable command} instances that are able to
...
public class CommandParser {
    ...
    public Callable< ? > getCommand( Map< String, String > argsParametersMap, String... args )
        ...
        NoSuchElementInDatabaseException, InvalidParameterValueException, InternalErrorException {
        ...
        Callable< ? > command =
                internalGetCommand( root, methodAndPathElements, 0, argsParametersMap );
        return command;
    }
