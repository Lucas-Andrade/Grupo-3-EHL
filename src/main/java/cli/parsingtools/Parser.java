...
public class Parser
{
	...
	static
	{
		try
		{
			TRANSLATORS.put( CLIStringsDictionary.HTML,
					new ToHtmlTranslator( 5 ) );
		}
		catch( InvalidArgumentException e )
		{// never happens because argument 5 is bigger than 1
		}
		TRANSLATORS
				.put( CLIStringsDictionary.TEXT, new ToPlainTextTranslator() );
	 ...
	 * parameter with name {@link CLIStringsDictionary#ACCEPT} received in the
	 ...
	 *         name {@link CLIStringsDictionary#ACCEPT} or<br/>
	 *         the translator {@link CLIStringsDictionary#TEXT} if no value was
	 *         received.
	 * @throws InvalidParameterValueException
	...
	public Translator getTranslator() throws InvalidParameterValueException {
		...
		if( t == null )
			throw new InvalidParameterValueException(
					CLIStringsDictionary.ACCEPT, translator );
		return t;
	}
	
	/**
	 * Returns the stream correspondent to the value of the parameter with name
	 * {@link CLIStringsDictionary#STREAM} received in the parameters-list of
	 * the string-command; if this parameter wasn't in the parameters-list
	 * returns the {@link PrintStream} {@link System#out}.
	 * 
	...
	public PrintStream getStream() throws InvalidParameterValueException {
		...
		{
			throw new InvalidParameterValueException(
					CLIStringsDictionary.STREAM, filePath, e.getMessage() );
		}
	}
