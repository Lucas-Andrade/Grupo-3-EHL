...
/**
 * Class whose instances are {@link StringsToCommandsFactory factories} that produce commands of type
...
public class PostUserCommandsFactory extends UserAuthenticatingFactory<User, String> {
	...
	public PostUserCommandsFactory(Database<User> postingUsersDatabase,
			Database<User> postedUsersDatabase) throws InvalidArgumentException {
		...
		this.requiredParametersNames = new String[] {CLIStringsDictionary.USERNAME,
				CLIStringsDictionary.PASSWORD, CLIStringsDictionary.EMAIL};
	}
