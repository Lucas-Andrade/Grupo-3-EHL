...
/**
 * Class whose instances are {@link Callable}s that delete an {@link Airship}
 * from the {@link Database} given its identification.
 * 
 ...
 */
public class DeleteAirshipCommand
	implements Callable< String >
{
	...
	/**
	 * Creates a new instance of this command that delete a {@link Airship} by
	 * its {@code identification}.
	 * 
	...
	/**
	 * Delete the {@code Airship} with the given {@code identification} from the {@code airshipDatabase}.
	 * If the {@code Airship} is deleted is returned the message <i>Airship successfully removed<i>,
	 * otherwise is returned <i>Airship doesn't exist in the database<i>.
	 * 
