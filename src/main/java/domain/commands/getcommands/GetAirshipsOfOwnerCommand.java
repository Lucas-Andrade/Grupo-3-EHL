...
public class GetAirshipsOfOwnerCommand implements Callable<Optional<Iterable<Airship>>> {
	...
	/**
	 * Returns the list of all airships in the {@code airshipDatabase} (given in the constructor) which were
	 * added by the user with {@code ownerUsername} (given in the constructor).
	 * <p>
