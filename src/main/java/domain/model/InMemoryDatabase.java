...
public abstract class InMemoryDatabase<T extends Element> implements Database<T> {
	 ...
	 * @see Optional
	 */
	public Optional<Iterable<T>> sortBy(Comparator<T> criteria) throws InvalidArgumentException {
	
		if (criteria == null)
			throw new InvalidArgumentException(
				"Cannot use a null criteria to sort the elements from " + databaseName);
