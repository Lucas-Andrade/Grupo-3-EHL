 ...
 *    <p>    {@literal -------------------------------} </p>
 *    <p>   {@literal |}  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 *  {@link JLabel}          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {@literal |} </p>
 *    <p>   {@literal |} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 *  {@link JTextField}        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {@literal |} </p>
 *    <p>     {@literal ------------------------------} </p>
 *
...
public class JLablePlusJTextField extends JPanel {
    ...
    /**
     * {@code TOPINSETS} int value that represents the size of top borders used in {@code GridBagConstraints}.
     */
    private static final int TOPINSETS = 10;
    /**
     * {@code LEFTINSETS} int value that represents the size of left borders used in {@code GridBagConstraints}.
     */
    private static final int LEFTINSETS = 0;
    /**
     * {@code BOTTOMINSETS} int value that represents the size of bottom borders used in {@code GridBagConstraints}.
     */
    private static final int BOTTOMINSETS = 0;
    /**
     * {@code RIGHTINSETS} int value that represents the size of right borders used in {@code GridBagConstraints}.
     */
    ...
    /**
     * {@code GRIDYPOSITIONFORLABEL} int value that represents the row where is insert the {@link JLabel} 
     * into {@code GridBagConstraints}.
     */
    private static final int GRIDYPOSITIONFORLABEL = 1;
    /**
     * {@code GRIDYPOSITIONFORLABEL} int value that represents the row where is insert the {@link JTextField} 
     * into {@code GridBagConstraints}.
     */
    ...
    /**
     * Public constructor that will create a {@link JLabelPlusTextField}. It will receive all the parameters
     * needed to create {@link JLabel} and {@link JTExtField}.  
     * 
     * @param jLabelText - String variable for the {@code label}.
     * @param jTextFieldSize - int value for the number of columns of {@code textField}.
     * @param jLabelcolor - Color variable for the {@code label}.
     * @param isJPasswordField - boolean variable that indicates if {@code textField} is a {@link JPasswordField}.
     * @param iconLabelPath - String variable with the image localization for {@code label}.
     */
    ...
    /**
     * 
     * Public constructor that creates a {@link JLablePlusJTextField} that is a {@link JTextField}, not a {@link JPasswordField} 
     * and does'nt has a {@code label} image. 
     * 
     * @param jLabelText - String variable for the {@code label}.
     * @param jTextFieldSize - int value for the number of columns of {@code textField}.
     * @param jLabelcolor - Color variable for the {@code label}.
    ...
    /**
     * Method responsible to create the {@link JLabel} and insert it into {@link JLablePlusJTextField} panel.
     * That will receive all the information needed to process the creation that are: 
     * 
     * @param jLabelText - String variable for the {@code label}.
     * @param jLabelcolor - Color variable for the {@code label}.  
     * @param iconLabelPath - String variable with the image localization for {@code label}.  
     * @throws InternalErrorException - when {@code iconPath} is not found.
     */
    private void createJlabel( String jLabelText, Color jLabelcolor, String iconPath ) {
        ...
        this.add( label, GridBagUtils.updateGridBagConstraints( constraints, GRIDXPOSITION, GRIDYPOSITIONFORLABEL,
                                                                new Insets( TOPINSETS, LEFTINSETS, BOTTOMINSETS, RIGHTINSETS) ) );
    }
    
    /**
     * Method responsible to create the {@link JTextField} and insert it into {@link JLablePlusJTextField} panel.
     * That will receive all the information needed to process the creation that are: 
     * 
     * @param jTextFieldSize - int value for the number of columns of {@code textField}.
     * @param isJPasswordField - boolean variable that indicates if {@code textField} is a {@link JPasswordField}.
    ...
    private void createTextField( int jTextFieldSize, boolean isJPasswordField ) {
        ...
        this.add( textField, GridBagUtils.updateGridBagConstraints( constraints, GRIDXPOSITION, GRIDYPOSITIONFORJTEXTFIELD,
                                                                    new Insets( TOPINSETS, LEFTINSETS, BOTTOMINSETS, RIGHTINSETS) ) );
