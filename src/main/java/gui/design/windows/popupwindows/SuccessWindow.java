...
/**
 * Class whose instances are {@link JDialog} with a success image and message, and a
...
public class SuccessWindow extends PopupWindow {
    ...
    /**
     * Creates a Success Pop-up with an {@code image}, a {@code message}, and a {@code ok-button}.
     * 
     * @param message
     */
