...
public class FunctionalPostAirshipWindow extends FunctionalWindow<String> {
	...
	@Override
	protected FunctionalWindow<String>.FunctionalWindowSwingWorker getSwingWorker() {
		...
		return new FunctionalWindowSwingWorker() {
			...
			protected String doInBackground() throws Exception {
				...
				if (functionalWindow.getTypeAirshipTabbedPane().getSelectedIndex() == 0) {
					...
					latitude = functionalWindow.getCivilAirshipCommonPainel().getGeoCoodinates()
						.getLatitude().getJTextField().getText();
					longitude = functionalWindow.getCivilAirshipCommonPainel().getGeoCoodinates()
						.getLongitude().getJTextField().getText();
					altitude = functionalWindow.getCivilAirshipCommonPainel().getGeoCoodinates()
						.getAltitude().getJTextField().getText();
					
					minAltitude = functionalWindow.getCivilAirshipCommonPainel().getAirCorridor()
						.getMinAltitude().getJTextField().getText();
					maxAltitude = functionalWindow.getCivilAirshipCommonPainel().getAirCorridor()
						.getMaxAltitude().getJTextField().getText();
					
					specificComponent = functionalWindow.getSpecificCivilPanel()
						.getNumberPassengerJTextField().getText();
					...
					latitude = functionalWindow.getMilitaryAirshipCommonPainel().getGeoCoodinates()
						.getLatitude().getJTextField().getText();
					longitude = functionalWindow.getMilitaryAirshipCommonPainel()
						.getGeoCoodinates().getLongitude().getJTextField().getText();
					altitude = functionalWindow.getMilitaryAirshipCommonPainel().getGeoCoodinates()
						.getAltitude().getJTextField().getText();
					
					minAltitude = functionalWindow.getMilitaryAirshipCommonPainel()
						.getAirCorridor().getMinAltitude().getJTextField().getText();
					maxAltitude = functionalWindow.getMilitaryAirshipCommonPainel()
						.getAirCorridor().getMaxAltitude().getJTextField().getText();
					
					specificComponent = functionalWindow.getSpecificMilitaryPanel()
						.getGroupButtons().getSelection().getActionCommand();
	...
	@Override
	protected void functionalWindowDone(String resultOfDoInBackGround) throws Exception {
