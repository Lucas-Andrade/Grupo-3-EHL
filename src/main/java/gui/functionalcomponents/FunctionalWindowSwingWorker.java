...
public abstract class FunctionalWindowSwingWorker< T > extends SwingWorker< T, Void > {
    ...
    /**
     * Caught and write the thrown {@link Exception}s by the {@link SwingWorker#doInBackground()} or
     * {@link FunctionalWindowSwingWorker#functionalDone} methods to the {@code errorLabel}.
     */
    @Override
    ...
    /**
     * Contract for subclasses where the result of the {@code doInBackground()} method will be
     * treated. Implementations decisions: The treatment of {@link Exception}s are caught in the
