 ...
 * where the {@link Exception}s thrown in the doInBackground() are caught and
 * write on the {@code errorLabel}.
 */
	...
	extends SwingWorker< T, Void >
{
	...
	/**
	 * Contract for subclasses where the result of the {@code doInBackground()} method 
