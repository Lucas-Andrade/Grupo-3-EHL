	...
	extends FunctionalWindow< Iterable< Airship > >
{
	...
	public FunctionalGetAirshipsWithLessPassengerThanWindow(
			GetAirshipsWithLessPassengerThanWindow nonFunctionalWindow, Database< Airship > airshipsDatabase,
		...
		return new FunctionalGetWindowSwingWorker( airshipsDatabase, bodyPanel, functionalWindow.getErrorLabel() )
		{
			...
			protected Iterable< Airship > doInBackground() throws Exception
			{
				return new GetAirshipsWithLessPassengersThanCommand(
						( InMemoryAirshipsDatabase )airshipsDatabase, StringUtils.parameterToInteger( "Maximum Number of Passengers", a ) ).call().get();
			}
