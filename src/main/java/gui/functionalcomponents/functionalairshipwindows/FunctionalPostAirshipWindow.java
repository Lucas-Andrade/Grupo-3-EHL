...
public class FunctionalPostAirshipWindow
	...
	protected FunctionalWindowSwingWorker< String > getSwingWorker()
	{
		return new FunctionalWindowSwingWorker< String >( functionalWindow.getErrorLabel() )
		{
			...
			protected String doInBackground() throws Exception
			{
				...
				{
					latitude =
							functionalWindow.getCivilAirshipCommonPainel()
											.getGeoCoodinates()
											.getLatitude()
											.getJTextField()
											.getText();
					...
					specificComponent =
							functionalWindow.getSpecificCivilPanel().getNumberPassengerJTextField().getText();
				...
				{
					latitude =
							functionalWindow.getMilitaryAirshipCommonPainel()
											.getGeoCoodinates()
											.getLatitude()
											.getJTextField()
											.getText();
					...
					specificComponent =
							functionalWindow.getSpecificMilitaryPanel()
											.getGroupButtons()
											.getSelection()
											.getActionCommand();
