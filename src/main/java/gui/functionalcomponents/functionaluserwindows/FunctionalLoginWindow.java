...
public class FunctionalLoginWindow extends FunctionalWindow< User > {
    ...
    /**
     * Give an {@link ActionListener}s to the given {@link FunctionalLoginWindow} buttons. To return
     * the functional {@code FunctionalLoginWindow} use the
