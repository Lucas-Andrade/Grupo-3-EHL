...
public class FunctionalPostUserWindow extends FunctionalWindow< String > {
    ...
    /**
     * Give an {@link ActionListener}s to the given {@link PostUserWindow} buttons. To return the
     * functional {@code PostUserWindow} use the {@link FunctionalWindow#getFunctionalWindow()}
     * method.
     * 
    ...
    /**
     * Get a {@link FunctionalWindowSwingWorker}, with all necessary info retrieved from
     * {@code postUserWindow}. The {@code doInBackground} method is {@code override}, to call the
