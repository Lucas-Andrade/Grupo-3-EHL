...
/**
 * Class whose instances will represent a military airship. This type of airships is distinguished
 * from the others because they have an extra boolean field that represents if they have have
 * weapons or not.
 * 
...
public class MilitaryAirship extends Airship {
	...
	/**
	 * Class constructor that will create an {@code Military Airship}. It will receive the
