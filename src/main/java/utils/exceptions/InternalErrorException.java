...
public class InternalErrorException extends RuntimeException {
    ...
    /**
     * Constructs an {@link InternalErrorException} with the message <i>«Sorry! An internal error
     * that was supposed to never happen happened.»</i> and the specified cause.
     * 
     * @param cause
    ...
    /**
     * Constructs an {@link InternalErrorException} with the specified detail message and the
     * specified cause.
     * 
     * @param message
     *            The detail message.
