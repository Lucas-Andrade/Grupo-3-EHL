...
public class GetTheNearestAirshipsToGeographicPositionCommandsFactory_Test
{
	...
	@Test
	public void shouldCreateTheCorrectInstanceCommand() throws InvalidArgumentException, InvalidRegisterException, UnknownCommandException, WrongLoginPasswordException, MissingRequiredParameterException, InvalidCommandSyntaxException, NoSuchElementInDatabaseException, InvalidParameterValueException, InvalidCommandParametersSyntaxException, DuplicateParametersException, InternalErrorException
	{
		...
		Callable<?> getTheNearestAirshipsToGeographicPositionCommand = (new Parser(cmdParser, "GET", "/airships/find", "nbAirships=2&latitude=60&longitude=225")).getCommand();
