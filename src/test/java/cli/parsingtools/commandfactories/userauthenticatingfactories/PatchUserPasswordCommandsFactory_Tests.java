...
public class PatchUserPasswordCommandsFactory_Tests {
	...
	public void shouldSuccessfullyCreateTheCorrectCommand() throws WrongLoginPasswordException,
		MissingRequiredParameterException, InvalidCommandSyntaxException, UnknownCommandException,
		NoSuchElementInDatabaseException, InvalidParameterValueException, InvalidArgumentException,
		InternalErrorException, Exception {
	
		Callable<?> patchUserPasswordCommand = (new PatchUserPasswordCommandsFactory(usersDatabase))
	...
	public void shouldThrowInvalidArgumentExceptionWhenTryingToCreateAPatchUserPasswordCommandsFactoryGivenANullUsersDatabase()
