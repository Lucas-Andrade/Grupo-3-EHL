...
public class HelpCommand_Tests {
	...
	@Test
	public void shouldGetAllCommandsDescription() throws WrongLoginPasswordException,
		...
		Assert.assertTrue(result.contains(new GetAirshipByFlightIdCommandsFactory(airshipsDatabase)
				.getCommandsDescription()));
		Assert.assertTrue(result.contains(new PatchUserPasswordCommandsFactory(usersDatabase)
				.getCommandsDescription()));
		Assert.assertTrue(result.contains(new PostUserCommandsFactory(usersDatabase, usersDatabase)
				.getCommandsDescription()));
