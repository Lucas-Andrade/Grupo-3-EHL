...
public class GetElementFromADatabaseByIdCommand_Tests {
	...
	public void shouldSuccessfullyGetTheCorrectAirshipGivenItsIdentification() throws Exception {
		...
		// Act
		getElementFromADatabaseById = new GetElementFromADatabaseByIdCommand(airshipsDatabase, airship1.getIdentification());
	...
	public void shouldSuccessfullyGetTheCorrectUserGivenItsIdentification() throws Exception {
		...
		// Act
		getElementFromADatabaseById = new GetElementFromADatabaseByIdCommand(userDatabase, "Daniel");
	...
	public void shouldThrowInvalidArgumentExceptionWhenTryingToCreateTheCommandGivenANullDatabase() throws InvalidArgumentException {
	...
	@SuppressWarnings ({"rawtypes", "unchecked"})
	@Test (expected = InvalidArgumentException.class)
	public void shouldThrowInvalidArgumentExceptionWhenTryingToCreateTheCommandGivenANullIdentification() throws InvalidArgumentException {

		getElementFromADatabaseById = new GetElementFromADatabaseByIdCommand(airshipsDatabase, null);
	}
	
	@SuppressWarnings ({"rawtypes", "unchecked"})
	@Test (expected = InvalidArgumentException.class)
	public void shouldThrowInvalidArgumentExceptionWhenTryingToCreateTheCommandGivenAnEmptyStringAsIdentification() throws InvalidArgumentException {
