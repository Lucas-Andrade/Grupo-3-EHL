...
public class GetTheNearestAirshipsToGeographicPositionCommand_Test {
	...
	public void shouldGiveAllTheAirshipsNearestOfTheGeograficCoordinate() throws Exception {
		...
		String actualResult = new GetTheNearestAirshipsToGeographicPositionCommand(
			airshipsDatabase, 2, 60, 225).call().toString();
		
		String expected = new StringBuilder("[").append(air1.toString()).append(", ")
