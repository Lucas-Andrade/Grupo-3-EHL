...
public class PatchAirshipCommands_Tests {
	...
	public void shouldPatchACivilAirshipWithTheCorrectParametersInTheGivenDatabase()
		...
		// Act
		patchAirship = new PatchAirshipCommand(airshipsDatabase, airship1.getIdentification(),
			user1, 2.0, 4.0, 13.0, 100.0, 50.0);
		
		// Assert
		Assert.assertEquals(patchAirship.call(), "Airship successfully patched");
		Assert.assertEquals(
			airshipsDatabase.getElementByIdentification(airship1.getIdentification()).toString(),
	...
	public void shouldPatchAMilitaryAirshipWithTheCorrectParametersInTheGivenDatabase()
		...
		// Act
		patchAirship = new PatchAirshipCommand(airshipsDatabase, airship2.getIdentification(),
			user1, 20., 10., 30., 100., 50.);
		
		// Assert
		Assert.assertEquals(patchAirship.call(), "Airship successfully patched");
		Assert.assertEquals(
			airshipsDatabase.getElementByIdentification(airship2.getIdentification()).toString(),
	...
	public void shouldNotPatchAnAirshipIfNoneOfTheParametersWereGiven() throws Exception {
		...
		// Act
		patchAirship = new PatchAirshipCommand(airshipsDatabase, "id20", user1, null, null, null,
			null, null);
	...
	public void shouldNotPatchAnAirshipThatDoesNotExistInTheDatabase() throws Exception {
		...
		// Act
		patchAirship = new PatchAirshipCommand(airshipsDatabase, "id20", user1, 0.0, 0.0, 0.0,
			100.0, 50.0);
	...
	public void shouldThrowInvalidArgumentExceptionWhenTryingToCreateThePatchCivilAirshipCommandGivenANullIdentification()
		...
		patchAirship = new PatchAirshipCommand(airshipsDatabase, null, user1, 0.0, 0.0, 0.0, 100.0,
			50.0);
	}
	
	@Test (
		expected = InvalidArgumentException.class)
	public void shouldThrowInvalidArgumentExceptionWhenTryingToCreateThePatchAirshipCommandGivenANullUser()
		throws InvalidArgumentException {
	
		patchAirship = new PatchAirshipCommand(airshipsDatabase, "id2", null, 0.0, 0.0, 0.0, 100.0,
			50.0);
	}
	
	@Test (
		expected = InvalidArgumentException.class)
	public void shouldThrowInvalidArgumentExceptionWhenTryingToPatchAnAirshipGivenInvalidParametersForItsFields()
		throws Exception {
