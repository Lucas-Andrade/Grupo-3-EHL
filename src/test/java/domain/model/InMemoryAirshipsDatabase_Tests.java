...
import main.java.utils.exceptions.databaseexceptions.*;
...
public class InMemoryAirshipsDatabase_Tests
{
	...
	public void shouldReceiveAMessageConfirmingThatAnyAirshipWasAddedByANullUser()
		...
		Assert.assertEquals( "No airship added by null", airshipDatabase
				.getAirshipsOfUser( null ).toString() );
	}
	...
	@Test
	public void shouldFindTheTwoAirshipsNearestToGeographicalPosition()
			throws InvalidArgumentException {
		...
		String result = airshipDatabase.getAirshipsCloserTo(
				new GeographicPosition( 60, 225, 10000 ), 2 ).toString();
		
		Assert.assertEquals( new StringBuilder( "[" ).append( air1.toString() )
				.append( ", " ).append( air3.toString() ).append( "]" )
				.toString(), result );
	}
	
	@Test
	public void shouldReturnAllAirshipsInAirshipsMemoryDatabseBecauseTheNumberAskedIsHigherThanAirshipsInDatabase()
			throws InvalidArgumentException {
		...
		String result = airshipDatabase.getAirshipsCloserTo(
				new GeographicPosition( 60, 225, 10000 ), 5 ).toString();
		
		String expectedResult = new StringBuilder( "[" )
				.append( air1.toString() ).append( ", " )
				.append( air3.toString() ).append( ", " )
				.append( air2.toString() ).append( "]" ).toString();
	...
	public void shouldThrowInvalidArgumentExceptionWhenTrytoGiveANegativeNumberOfAirshipsToFindAtgetAirshipsCloserToMethod()
		...
		airshipDatabase.getAirshipsCloserTo( new GeographicPosition( 60, 225,
				10000 ), -3 );
	}
}