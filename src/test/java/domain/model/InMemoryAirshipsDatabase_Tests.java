...
public class InMemoryAirshipsDatabase_Tests {
    ...
    public void shouldFindTheTwoAirshipsNearestToGeographicalPosition()
        ...
        String result =
                airshipDatabase.getAirshipsCloserTo( new GeographicPosition( 60, 225, 10000 ), 2 )
                               .toString();
        
        Assert.assertEquals( new StringBuilder( "[" ).append( air1.toString() ).append( ", " )
    ...
    public
            void
            shouldReturnAllAirshipsInAirshipsMemoryDatabseBecauseTheNumberAskedIsHigherThanAirshipsInDatabase()
                throws InvalidArgumentException {
        ...
        String result =
                airshipDatabase.getAirshipsCloserTo( new GeographicPosition( 60, 225, 10000 ), 5 )
                               .toString();
    ...
    public
            void
            shouldThrowInvalidArgumentExceptionWhenTrytoGiveANegativeNumberOfAirshipsToFindAtgetAirshipsCloserToMethod()
                throws InvalidArgumentException {
