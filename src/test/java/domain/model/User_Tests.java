...
public class User_Tests
{
	...
	public void VerifyIfUsersAreEquals() throws InvalidArgumentException {
		...
		Assert.assertTrue( user1.equals( new User( "Pedro", "pass",
				"pedro@gmail.com", "Pedro Antunes" ) ) );
	...
	public void VerifyIfUsersHasDiferentsUsernames()
		...
		Assert.assertFalse( user1.equals( new User( "Gonçalo", "pass",
				"pedro@gmail.com", "Pedro Antunes" ) ) );
	}
	...
	public void VerifyIfUsersHasDiferentsEmails()
		...
		Assert.assertFalse( user1.equals( new User( "Pedro", "pass",
				"Gonçalo@gmail.com", "Pedro Antunes" ) ) );
	}
	...
	public void ShouldReturnAStringWithoutPasswordButWithAnFullname() {
		...
		Assert.assertEquals(
				"username: Pedro, email: pedro@gmail.com, fullName: Pedro Antunes\n",
	...
	@Test
	public void OnlyBecauseIWant100PercentCoverage()
			throws InvalidArgumentException {
	...
	public void ShouldThrowInvalidArgumentExceptionWhenUsernameIsNull()
		...
		new User( null, "pass", "pantunes@gmail.com",
				"Pantunes da Silva Pantunes" );
	}
	...
	public void ShouldThrowInvalidArgumentExceptionWhenPasswordIsNull()
		...
		new User( "Pantunes", null, "pantunes@gmail.com",
				"Pantunes da Silva Pantunes" );
	}
	...
	public void ShouldThrowInvalidArgumentExceptionWhenEmailDoesntHaveAt()
		...
		new User( "Pantunes", "pass", "pantunesgmail.com",
				"Pantunes da Silva Pantunes" );
	}
	...
	public void ShouldThrowInvalidArgumentExceptionWhenEmailDoesntHaveOnlyOneAt()
		...
		new User( "Pantunes", "pass", "pant@unes@gmail.com",
				"Pantunes da Silva Pantunes" );
	}
	...
	public void ShouldThrowInvalidArgumentExceptionWhenUsernameIsAnEmptyString()
		...
		new User( "", "pass", "pantunes@gmail.com",
				"Pantunes da Silva Pantunes" );
	}
	...
	public void ShouldThrowInvalidArgumentExceptionWhenPasswordIsAnEmptyString()
		...
		new User( "pantunes", "", "pantunes@gmail.com",
				"Pantunes da Silva Pantunes" );
	}
