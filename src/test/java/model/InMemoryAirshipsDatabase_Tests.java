...
public class InMemoryAirshipsDatabase_Tests {
	...
	@Test
	public void shouldNotRemoveAnAirshipThatDoesNotExist() throws DatabaseException {

		try {
			// Assert
			assertFalse(airshipDatabase.removeByIdentification(airship.getIdentification()));
		} catch (InvalidArgumentException e) {
			e.printStackTrace();
		}
	}
	...
	public void shouldFindTheTwoAirshipsNearestToGeographicalPosition()
		...
		String result = airshipDatabase.getAirshipsCloserTo(new GeographicPosition(60, 225, 10000),
				2).toString();
	...
	public void shouldReturnAllAirshipsInAirshipsMemoryDatabseBecauseTheNumberAskedIsHigherThanAirshipsInDatabase()
		...
		String expectedResult = new StringBuilder("[").append(air1.toString()).append(", ")
				.append(air3.toString()).append(", ").append(air2.toString()).append("]")
				.toString();
