...
public class OptionalTest
{
	...
	public void test() throws InvalidArgumentException {
		...
		new Optional<User>(new User ("pantunes","pantunesPassword","pantunes@gmail.com"), new InvalidArgumentException() );
	...
	public void test5() throws InvalidArgumentException {
		...
		new Optional<User>(new User ("pantunes","pantunesPassword","pantunes@gmail.com") , new InvalidArgumentException(),"TEST");
	...
	public void test6() throws InvalidArgumentException {
		...
		new Optional<User>(new User ("pantunes","pantunesPassword","pantunes@gmail.com") , null ,"TEST");
	...
	public void test7() throws InvalidArgumentException {
		...
		Optional<User> optional = new Optional<User>(new User ("pantunes","pantunesPassword","pantunes@gmail.com") ,
	...
	public void test9() throws InvalidArgumentException {
		...
		Optional<Map<String,String>> optional = new Optional<Map<String,String>> (MapTester ,new InvalidArgumentException() ,"TEST");
	...
	public void test11() throws InvalidArgumentException {
		...
		Optional<Collection<String>> optional = new Optional<Collection<String>> (MapTester ,new InvalidArgumentException() ,"TEST");
	...
	public void test14() throws InvalidArgumentException {
		...
		Optional<Collection<String>> optional = new Optional<Collection<String>> (MapTester ,new InvalidArgumentException() , null);
	...
	public void test18() throws Exception  {
		...
		Optional<Collection<String>> optional = new Optional<Collection<String>> (null ,new InvalidArgumentException() , null);
